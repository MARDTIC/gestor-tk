"""
Esta parte genera la interfaz grafica 
sin prescindir de de la interface por
consola que queda como alternativa
"""
...
class MainWindow(Tk, CenterWidgetMixin):
    ...
    def build(self): # Metodo para construir. Buena practica
        frame = Frame(self)
        frame.pack()
        ...
        self.treeview = treeview # PARA PODER IMPORTARLO EN OTRAS PARTES DEL PROYECTO
